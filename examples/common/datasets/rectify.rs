...
use kornia_imgproc::calibration::distortion::{PolynomialDistortion, distort_point_polynomial};
...
impl StereoRectifier {
    ...
    #[allow(dead_code)] // public API; used by later stereo increments + tests
